//CSE-202 PROJECT
//hospital online appoinment
/*
project by;
NAME-NAMPALLY PRANAY,
REG NO-11902943,
SECTION-K19KH,
ROLL no-16,
*/
...
{	
	...
	switch (id)
	{
		case 1:
		{
			cout<<"Name - DR.K.Chandrasheaker"<<endl;
			cout<<"Gender - Male"<<endl;
			cout<<"CARDIOLOGIST"<<endl;
			cout<<"Age - 32 Years"<<endl;
			break;
					
		}
		case 2:
		{
			cout<<"Name - DR.N.Tharak"<<endl;
			cout<<"Gender - Male"<<endl;
...
cout<<"\t\t\t\t\t@@|                                  WELCOME TO                                           |@@\n";
cout<<"\t\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t\t@@|                              REENUKHA HOSPITALS                                       |@@\n";
cout<<"\t\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t\t@@|                               Infront of SBI,                                         |@@\n";
cout<<"\t\t\t\t\t@@|                               Panjaguta,Hyderabad,                                    |@@\n";
cout<<"\t\t\t\t\t@@|                               Telangana,Pin-505209.                                   |@@\n";
cout<<"\t\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t\t@@|_______________________________________________________________________________________|@@\n";
cout<<"\t\t\t\t\t@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n\n\n\n\t\t\t\t\t";
...
cout<<"\t\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t\t@@|              -------REEUNAKHA DIGITAL ONLINE APPLICATIONS-------                      |@@\n";
cout<<"\t\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t\t@@|_______________________________________________________________________________________|@@\n";
cout<<"\t\t\t\t\t@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n\n\n\n\t\t\t\t\t";
